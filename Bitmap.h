...
public:
	...
	void Draw(HDC hDC, int x, int y, BOOL bTrans = FALSE, COLORREF crTransColor = RGB(0, 0, 0));
	void DrawPart(HDC hDC, int x, int y, int xPart, int yPart, int wPart, int hPart, BOOL bTrans = FALSE, COLORREF crTransColor = RGB(0, 0, 0));
